...
import {works} from './data/trabalhos.json'
import { Work, getWork } from './models/Work'
import WorkCard from './components/WorkCad'
...
const App =() => {
    ...
    return(
        <Container>
            ...
            {
                (worksToBeShown.length>0) && worksToBeShown.map((w,index)=> <WorkCard key={index} title={w.title} authors={w.authors}/>)
            }
        </Container>
    )
}
